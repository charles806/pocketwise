          ...
          <div className="p-6">
            <div className="flex flex-col items-center text-center mb-6">
              ...
              <p className="text-sm text-[#475569] mt-2">
                Move {formatNaira(currentAmount).replace("NGN", "₦")} to your
                Spend wallet and mark this goal as completed.
              </p>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={submitting}
                className="flex-1 rounded-xl bg-emerald-600 px-3 py-3 text-xs font-semibold text-white transition-colors hover:bg-emerald-700 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
