...
const socialLinks: { label: string; href: string; icon: ReactNode }[] = [
  {
    label: "X (Twitter)",
    href: "https://twitter.com/Pocketwisefin",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/pocketwise_tech",
    icon: (
      <svg className="size-4.5" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "TikTok",
    href: "https://tiktok.com/@pocketwisefin",
    icon: (
      <svg className="size-4.5" viewBox="0 0 24 24" fill="currentColor">
...
export default function Footer() {
  return (
    <footer className="bg-linear-to-b from-[#0f0f1a] to-black relative overflow-hidden">
      {/* Decorative elements */}
      <div
          ...
          >
            <div>
              ...
              <p className="text-[#9ca3af] text-sm">
                Join the waitlist and get ₦1000 credit on launch day.
              </p>
            </div>
            <Link
              href="/waitlist"
